...
def footer(canvas, doc):
    ...
    canvas.drawString(22*mm, 12*mm, "MSK Kikinda — Petkoks: nabavka i isporučena cena")
...
OUT = "/tmp/claude-0/-home-user-awesome-mcp-servers/d51bb9dc-117d-5f8b-b31d-d3001a459de9/scratchpad/MSK-Petkoks-Nabavka-Sep2026.pdf"
doc = SimpleDocTemplate(OUT, pagesize=A4,
                        leftMargin=22*mm, rightMargin=22*mm,
                        topMargin=20*mm, bottomMargin=20*mm,
                        title="MSK Kikinda — Petkoks: nabavka i isporučena cena",
